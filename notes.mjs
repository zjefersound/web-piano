export const NOTES = [
    ...
    { key: "C6", type: "normal", path: "/notes/C6.mp3", keyboardKey: 'z' },
    { key: "Db6", type: "sharp", path: "/notes/Db6.mp3", keyboardKey: 's' },
    { key: "D6", type: "normal", path: "/notes/D6.mp3", keyboardKey: 'x' },
    { key: "Eb6", type: "sharp", path: "/notes/Eb6.mp3", keyboardKey: 'd' },
    { key: "E6", type: "normal", path: "/notes/E6.mp3", keyboardKey: 'c' },
    { key: "F6", type: "normal", path: "/notes/F6.mp3", keyboardKey: 'v' },
    { key: "Gb6", type: "sharp", path: "/notes/Gb6.mp3", keyboardKey: 'g' },
    { key: "G6", type: "normal", path: "/notes/G6.mp3", keyboardKey: 'b' },
    { key: "Ab6", type: "sharp", path: "/notes/Ab6.mp3", keyboardKey: 'h' },
    { key: "A6", type: "normal", path: "/notes/A6.mp3", keyboardKey: 'n' },
    { key: "Bb6", type: "sharp", path: "/notes/Bb6.mp3", keyboardKey: 'j' },
    { key: "B6", type: "normal", path: "/notes/B6.mp3", keyboardKey: 'm' },
];
Object.freeze(NOTES);
